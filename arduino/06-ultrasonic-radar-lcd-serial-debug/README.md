# Ultrasonic Radar Scanner with Serial Debugging

**Platform:** Arduino

## Overview

A debug-oriented variant of the ultrasonic radar scanner that adds serial output for echo duration and measured distance.
...
This is a close variant of the LCD radar project. It retains the same core scanning behavior while adding Serial diagnostics.
