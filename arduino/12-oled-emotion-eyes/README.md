# OLED Animated Emotion Eyes

**Platform:** Arduino

## Overview

An interactive-style OLED face animation featuring blinking, sleeping, waking, happy, angry, sad, surprised, wink, and heart-eye expressions.
...
The sketch can run a demo sequence and can also receive an `A<number>` animation command over Serial.
