# Ultrasonic Radar Scanner with Servo and LCD

**Platform:** Arduino

## Overview

Sweeps an ultrasonic sensor through 0–180° using a servo and shows the measured angle and distance on a 16x2 I2C LCD.
