# Traffic Light and Vehicle Gate Controller

**Platform:** Arduino

## Overview

Combines a traffic-light sequence with an ultrasonic vehicle detector, servo gate, and five auxiliary LEDs. Vehicle checking continues while each traffic-light phase is running.
