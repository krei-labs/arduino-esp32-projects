# Smart Room Occupancy and Door Control System

**Platform:** Arduino

## Overview

A room-management prototype using IR entry detection, ultrasonic exit detection, a servo door, DHT11 temperature/humidity sensing, LCD status, capacity tracking, and a full-room alarm.
...
Despite the original folder name `machinelearning`, the supplied code implements an embedded smart-room/occupancy system rather than a machine-learning algorithm.
