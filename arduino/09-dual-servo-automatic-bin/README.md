# Ultrasonic Automatic Dual-Servo Bin

**Platform:** Arduino

## Overview

Opens two servo-controlled mechanisms when an ultrasonic sensor detects an object within a configurable distance threshold.
