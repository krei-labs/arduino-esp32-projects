# Smart Parking Gate and Car Counter

**Platform:** Arduino

## Overview

Uses an IR sensor to detect incoming cars, a servo to operate a gate, an ultrasonic sensor to detect a vehicle leaving, and an LCD to show the current car count.
