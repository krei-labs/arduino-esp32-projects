# OLED 48x48 Bitmap Animation

**Platform:** Arduino

## Overview

Displays a pre-generated 48x48 monochrome bitmap animation on an SSD1306 OLED display.
...
The animation frames are embedded directly in the source as bitmap data.
