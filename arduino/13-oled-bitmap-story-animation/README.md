# OLED Bitmap Story Animation

**Platform:** Arduino

## Overview

A large embedded-frame SH1106 OLED animation using 128x64 bitmap frames and timed playback.
...
The source contains a large array of bitmap frames, so the repository is intentionally code-heavy.
